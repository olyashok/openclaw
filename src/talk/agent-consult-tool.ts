  ...
  parameters: {
    ...
    properties: {
      ...
      confirmationId: {
        type: "string",
        description:
          "Exact server-issued id from a prior VOICE_CONFIRMATION_REQUIRED result. After explicit spoken confirmation, retry the same request with this id unchanged; never use it for a changed action.",
      },
    },
    required: ["question"],
  },
